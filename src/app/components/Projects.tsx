...
const projectData = [
  {
    ...
    image: '/3.png',
    video: '/ErasmusUGR/erasmusugrmini.mp4',
    github: 'https://github.com/blancagiron/eramus-ugr',
    link: '/gallery#ErasmusUGR',
  },
  {
    title: 'GranaBus',
    description:
      'A Telegram bot that provides real-time bus schedules for interurban routes in Granada. This educational project fetches live data from the Granada Transport Consortium API, allowing users to quickly look up arrival times by searching for a specific stop.',
    tech: ['Python', 'Flask', 'python-telegram-bot'],
    image: '/1.png',
    github: 'https://github.com/blancagiron/granabus',
    link: '/gallery#GranaBus',
  },
  {
    title: 'Online Store',
    description:
    ...
    <section id="proyectos" className="py-32 container mx-auto px-6 max-w-7xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
        {projectData.map((project) => (
          ...
          >
            {/* Project image/video with hover */}
            <div className="relative aspect-video overflow-hidden bg-gray-100">
              {project.video && hoveredProject === project.title ? (
                <video
                  src={project.video}
                  autoPlay
                  loop
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-gray-900/40 via-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
            </div>
